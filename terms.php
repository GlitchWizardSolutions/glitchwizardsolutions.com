...
<script>
  ...
  <title>Terms of Service - GlitchWizard Solutions - Digital Foundations to Build Your Small Business in Affordable Stages</title>
  <meta name="description" content="This page documents and displays the Terms and Service for GlitchWizard Solutions." >
...
<div id="policy_embed_div" width="640" height="480" 
 data-policy-key="UkRCdGNqaElMMGRaZFN0MmJVRTlQUT09"  data-extra="css-compatibility=true&amp;h-align=left&amp;table-style=accordion" > Please wait while the policy is loaded. If it does not load, please <a rel="nofollow" href="https://app.termageddon.com/api/policy/UkRCdGNqaElMMGRaZFN0MmJVRTlQUT09?css-compatibility=true&amp;h-align=left&table-style=accordion" target="_blank">click here</a>. </div><script src="https://app.termageddon.com/js/termageddon-compatibility.js"></script>
</div>
  </main><!-- End #main -->
      ...
      <div class="container">
        ...
        <div class="row  justify-content-center">
          <div class="col-lg-6">
            ...
            <p>Our processs of developing a business digital presence in stages, is based on the most value for your investment as your business grows. </p>
          </div>
        </div>
