...
<div id="policy_embed_div" width="640" height="480" 
 data-policy-key="Tm5oMVdEQm9VblpEVTFRMGVHYzlQUT09"  data-extra="css-compatibility=true&h-align=left&table-style=accordion" > Please wait while the policy is loaded. If it does not load, please <a rel="nofollow" href="https://app.termageddon.com/api/policy/Tm5oMVdEQm9VblpEVTFRMGVHYzlQUT09?css-compatibility=true&h-align=left&table-style=accordion" target="_blank">click here</a>. </div>
 <script src="https://app.termageddon.com/js/termageddon-compatibility.js"></script>
